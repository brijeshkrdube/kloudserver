        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-text-secondary mb-6 max-w-sm">
              Enterprise-grade cloud infrastructure for businesses of all sizes. 
              Reliable, scalable, and secure hosting solutions.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded bg-white/5 flex items-center justify-center text-text-secondary hover:text-primary hover:bg-white/10 transition-all" data-testid="social-twitter">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 rounded bg-white/5 flex items-center justify-center text-text-secondary hover:text-primary hover:bg-white/10 transition-all" data-testid="social-github">
                <Github className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 rounded bg-white/5 flex items-center justify-center text-text-secondary hover:text-primary hover:bg-white/10 transition-all" data-testid="social-linkedin">
